<template lang="pug">
  div
    h3 FairShare - einfach "fairteilen"
    ...
    ul
      li Anteile der Firma verteilen sich mit der Zeit auf alle, die mitmachen.
    ...
    h3 Demo
    nuxt-link(to="demo") Probier aus, wie es funktioniert
